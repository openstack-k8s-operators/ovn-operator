...
// Package main is the entry point for the ovn-operator.
package main
...
import (
	...
	"github.com/openstack-k8s-operators/ovn-operator/internal/controller"
	webhookv1beta1 "github.com/openstack-k8s-operators/ovn-operator/internal/webhook/v1beta1"
...
func main() {
	...
	if err := (&controller.OVNNorthdReconciler{
	...
	if err := (&controller.OVNDBClusterReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(mgr); err != nil {
	...
	if err := (&controller.OVNControllerReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(mgr); err != nil {
	...
	if strings.ToLower(os.Getenv("ENABLE_WEBHOOKS")) != "false" {
		if err := webhookv1beta1.SetupOVNNorthdWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OVNNorthd")
			os.Exit(1)
		}
		if err := webhookv1beta1.SetupOVNDBClusterWebhookWithManager(mgr); err != nil {
