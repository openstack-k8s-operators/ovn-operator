...
func (r *OVNControllerReconciler) reconcileNormal(ctx context.Context, instance *ovnv1.OVNController, helper *helper.Helper) (ctrl.Result, error) {
	...
	networkAttachments, err := ovncontroller.CreateAdditionalNetworks(ctx, helper, instance, ovnServiceLabels)
	if err != nil {
	...
	networkReady, networkAttachmentStatus, err := nad.VerifyNetworkStatusFromAnnotation(ctx, helper, networkAttachmentsNoPhysNet, ovnServiceLabels, instance.Status.NumberReady)
	if err != nil {
		return ctrl.Result{}, err
	}
