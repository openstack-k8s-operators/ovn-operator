...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/common v0.3.1-0.20240423125257-1a6c447deefe
	github.com/openstack-k8s-operators/lib-common/modules/test v0.3.1-0.20240423125257-1a6c447deefe
